...
from sklearn.metrics import roc_auc_score, ConfusionMatrixDisplay  # ✅ FIXED
...
def go(args):
    ...
    ConfusionMatrixDisplay.from_estimator(  # ✅ FIXED
        pipe,
        X_test[used_columns],
        y_test,
        ax=sub_cm,
    ...
    sub_cm.set_title("Normalized Confusion Matrix")
    fig_cm.tight_layout()
